      ...
      {dispute && !status && !resolution && (isOpener
        ...
        : alreadyResponded
          ...
          : <form onSubmit={submit} className="mt-6 space-y-5">
            <label className="block font-semibold">Your reply<MentionTextarea required value={statement} onChange={setStatement} parties={buildDisputeParties(order)} selfKey={mySide} rows="6" className="mt-2 w-full rounded-xl border p-3 font-normal" placeholder="Reply to ProofPay admin or the other party. Explain your side and reference dates or delivery details." /></label>
